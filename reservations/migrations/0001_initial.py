# Generated by Django 5.2.4 on 2025-08-03 22:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-date', '-time'],
                'constraints': [models.UniqueConstraint(fields=('table', 'date', 'time'), name='unique_reservation'), models.CheckConstraint(condition=models.Q(('duration__gte', 1), ('duration__lte', 6)), name='duration_range_check')],
            },
        ),
    ]
